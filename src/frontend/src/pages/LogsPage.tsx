...
export default function LogsPage() {
  ...
  return (
    <div className="p-6 h-full flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              className="bg-[var(--panel-bg)] border border-white/10 text-[var(--text-primary)] text-sm rounded-lg pl-9 pr-3 py-2 w-56 placeholder-gray-600 focus:ring-1 focus:ring-[var(--accent-blue)] focus:border-[var(--accent-blue)]"
              placeholder="过滤日志..."
              value={search}
          ...
          {/* Level filters */}
          <div className="flex bg-[var(--panel-bg)] rounded-lg p-1 border border-white/10">
            {LEVELS.map(l => (
      ...
      {/* Terminal */}
      <div className="flex-1 bg-[var(--header-bg)] rounded-xl border border-white/10 shadow-2xl overflow-hidden flex flex-col font-mono text-sm">
        {/* Terminal header */}
        <div className="h-8 bg-[var(--panel-bg-alt)] border-b border-white/5 flex items-center px-4 justify-between select-none">
        ...
        {/* Status bar */}
        <div className="h-6 bg-[var(--panel-bg-alt)] border-t border-white/5 flex items-center justify-between px-3 text-[10px] text-gray-600">
